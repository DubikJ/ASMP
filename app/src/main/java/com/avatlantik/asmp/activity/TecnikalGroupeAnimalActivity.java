...
public class TecnikalGroupeAnimalActivity extends ActionBarActivity{
    ...
    protected void onResume() {
        ...
        if(typeAnimal==TYPE_GROUP_ANIMAL_ALL) {
            ...
            activityUtils.showSelectionGrid(TecnikalGroupeAnimalActivity.this,
                    ...
                    listGroupsAnimals, 2, new ActivityUtils.ListGridItemClick() {
                        ...
                        public void onItemClik(int item) {
                            typeAnimal = listGroupsAnimals.get(item).getId();
                            initData();
                        }
                    });
        }else{
    ...
    private void initDataToListView(){
        List<Animal> groupeList = dataRepository.getTecnicalGroupsAnimalsByTypeAnimal(typeAnimal);
        ...
        TreeViewItemClickListener treeViewItemClickListener = new TreeViewItemClickListener(adapter,
                new TreeViewItemClickListener.ListItemClick() {
                    ...
                    public void onItemClik(final Element element) {
                        activityUtils.showQuestion(TecnikalGroupeAnimalActivity.this, getString(R.string.action_selection),

...
public class NewAnimalActivityOLD extends AppCompatActivity{
      ...
      //  ((ASMPApplication) getApplication()).getComponent().inject(this);
        ...
        selectedImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedPhoto ==null){
                    ...
                    Intent intent = new Intent(NewAnimalActivityOLD.this, ImageActivity.class);
        ...
        breedTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activityUtils.showSelectionList(NewAnimalActivityOLD.this,
    ...
    public void onBackPressed() {
        ...
        activityUtils.showQuestion(NewAnimalActivityOLD.this, getString(R.string.questions_title_info),
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAPTURE_CAMERA_ACTIVITY_REQ) {
            ...
            if(selectedPhoto==null){
                ...
                selectedPhoto = new PhotoItem(String.valueOf(nameTV.getText()),
    ...
    private File initPhotoFile(String nameFile) {
        return photoFileUtils.getPhotoFile(false, nameFile);
    }
